...
void setup()
{
  ...
  //-- Set min and max values with negative values
  lpg.setRangeValue1(-512, 511);
  lpg.setRangeValue2(-1023, 0);
  delay(50);
}

void loop()
{
  int r4 = analogRead(pinR4); // 0 to 1023
  int r5 = analogRead(pinR5); // 0 to 1023
